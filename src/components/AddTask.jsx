...
export const AddTask = () => {
  ...
  return (
    <div className='flex flex-row justify-center items-center bg-gray-800 rounded mx-10 mb-8 p-2 h-12 text-gray-500 bg-opacity-90 hover:bg-gray-900 hover:bg-opacity-70'>
      <span
